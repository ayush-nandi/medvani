  ...
  return (
    <div className="flex min-h-[100dvh] items-center justify-center bg-[radial-gradient(circle_at_20%_20%,#10b98122,transparent_35%),radial-gradient(circle_at_80%_80%,#10b9811a,transparent_35%),#121212] px-4 py-8">
      <motion.div
        ...
        className="flex h-[720px] w-full max-w-5xl overflow-hidden rounded-2xl border border-zinc-800 bg-[#171717] shadow-2xl shadow-black/40"
      >
        ...
        <section className="flex flex-1 flex-col justify-start bg-[#171717] px-6 py-8 md:px-16 md:py-10">
          <div className="mb-6">
            <h1 className="mb-3 text-3xl font-semibold text-zinc-100">Welcome to MedVani</h1>
            <p className="text-sm text-zinc-400">
              Create your account to access personalized health guidance and multilingual AI support.
            </p>
          </div>
          ...
          <button
            ...
            type="button"
            onClick={onGoogle}
            className="mb-4 flex w-full items-center justify-center gap-3 rounded-lg border border-zinc-700 bg-zinc-900 py-3 text-sm font-medium text-zinc-100 transition-colors hover:bg-zinc-800 disabled:opacity-60"
          >
